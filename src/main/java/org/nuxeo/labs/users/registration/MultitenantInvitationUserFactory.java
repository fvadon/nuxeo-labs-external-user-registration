...
public class MultitenantInvitationUserFactory implements InvitationUserFactory {

    private static final Log log = LogFactory.getLog(MultitenantInvitationUserFactory.class);
    private static final String TENANT_ID_COLUMN = "user:tenantId";
    private static final String TENANT_ID = "userinfo:tenantId";
    ...
    public NuxeoPrincipal doCreateUser(CoreSession session,
        ...
        if (user == null) {
            ...
            newUserDoc.setPropertyValue(
                    TENANT_ID_COLUMN,
                    registrationDoc.getPropertyValue(TENANT_ID));
